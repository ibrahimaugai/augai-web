...
import machineLearningBanner from "../public/machinelearningbanner.jpg";
import machineLearningInnovationImage from "../public/machinelearning.png";
    ...
    <>
      <div className="flex h-[100svh] max-h-[100svh] min-h-0 flex-col overflow-hidden bg-white text-neutral-900">
        ...
        <section
          ...
          aria-labelledby="machine-learning-heading"
        >
          <div className="pointer-events-none absolute inset-0">
            <Image
              src={machineLearningBanner}
              alt=""
              fill
              priority
