...
export default function NaturalLanguageProcessing() {
  return (
    <>
              ...
              <div className="ml-3 sm:ml-4 lg:ml-6">
                <div className="pl-3 sm:pl-4 lg:pl-6">
                  ...
                  <p className="mt-4 max-w-4xl text-[clamp(1rem,1.05vw+0.85rem,1.3125rem)] leading-relaxed tracking-normal text-white/95 sm:mt-6 sm:max-w-[42rem] sm:leading-[1.72] lg:mt-8 lg:max-w-[46rem] lg:text-[clamp(1.0625rem,1.35vw,1.35rem)] lg:leading-[1.72]">
                    Process text at scale with NLP—summarization, sentiment, classification,
                    and extraction that turn documents, feedback, and conversations into
      ...
      <InnovationSection contentKey="naturallanguageprocessing" sideImage={naturalInnovationImage} />
      <KeyPointsSection contentKey="naturallanguageprocessing" />
      <AiDevelopmentSection contentKey="naturallanguageprocessing" />
      <ServicesQuestionsSection contentKey="naturallanguageprocessing" />
      <MainFooterSection />
    </>
  );
}
