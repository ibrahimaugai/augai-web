...
import devopsBanner from "../public/devopsbanner.jpg";
import devopsImage from "../public/devopsimage.png";
...
export default function DevOps() {
  return (
    <>
              ...
              <div className="ml-3 sm:ml-4 lg:ml-6">
                <div className="pl-3 sm:pl-4 lg:pl-6">
                  ...
                  <p className="mt-4 max-w-4xl text-[clamp(1rem,1.05vw+0.85rem,1.3125rem)] leading-relaxed tracking-normal text-white/95 sm:mt-6 sm:max-w-[42rem] sm:leading-[1.72] lg:mt-8 lg:max-w-[46rem] lg:text-[clamp(1.0625rem,1.35vw,1.35rem)] lg:leading-[1.72]">
                    Accelerate delivery with DevOps practices—CI/CD pipelines, cloud
                    infrastructure, and monitoring that improve reliability and help your
                    team ship features with less downtime.
                  </p>
      ...
      <InnovationSection contentKey="devops" sideImage={devopsImage} />
      <KeyPointsSection contentKey="devops" />
      <AiDevelopmentSection contentKey="devops" />
      <ServicesQuestionsSection contentKey="devops" />
      <MainFooterSection />
    </>
  );
}
