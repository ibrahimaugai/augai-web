...
import predictiveBanner from "../public/predictivemodeling.jpg";
import roboticHandImage from "../public/3d-rendering-robotic-hand-working-with-hud-display 1.png";
    ...
    <>
      <div className="flex h-[100svh] max-h-[100svh] min-h-0 flex-col overflow-hidden bg-white text-neutral-900">
        ...
        <section
          ...
          aria-labelledby="predictive-modeling-heading"
        >
          <div className="pointer-events-none absolute inset-0">
            <Image
              src={predictiveBanner}
              alt=""
              fill
              priority
            ...
            />
            <div
              className="absolute inset-0 bg-gradient-to-r from-blue-950/80 via-fuchsia-600/50 to-pink-500/55"
              aria-hidden
            />
          </div>
            ...
            <main className="w-full min-h-0 px-3 sm:px-4 lg:px-6">
              <div className="ml-3 sm:ml-4 lg:ml-6">
                <div className="pl-3 sm:pl-4 lg:pl-6">
                  <h1
                    id="predictive-modeling-heading"
                  ...
                  <p className="mt-4 max-w-4xl text-[clamp(1rem,1.05vw+0.85rem,1.3125rem)] leading-relaxed tracking-normal text-white/95 sm:mt-6 sm:max-w-[42rem] sm:leading-[1.72] lg:mt-8 lg:max-w-[46rem] lg:text-[clamp(1.0625rem,1.35vw,1.35rem)] lg:leading-[1.72]">
                    Use your historical data to forecast demand, risk, and outcomes
                    with models built for your market—so leaders can plan ahead with
                    clearer, evidence-based confidence.
                  </p>
      ...
      <InnovationSection contentKey="predictivemodeling" sideImage={roboticHandImage} />
      <KeyPointsSection contentKey="predictivemodeling" />
      <AiDevelopmentSection contentKey="predictivemodeling" />
      <ServicesQuestionsSection contentKey="predictivemodeling" />
      <MainFooterSection />
    </>
  );
}
